...
#figure(
  ...
  caption: [Qualitative raster-vector-raster comparison for images generated by the fine-tuned `z-image` pipeline. Each method row shows the rendered SVG obtained from the corresponding reference raster.],
