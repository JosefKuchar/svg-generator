...
#figure(
  ...
  caption: [Qualitative raster-vector-raster comparison for images generated by the fine-tuned `z-image` pipeline. The `vtracer` row shows the rendered SVG obtained from each reference raster.],
