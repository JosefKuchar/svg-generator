...
\begin{columns}[T,onlytextwidth]
  \begin{column}{.52\textwidth}
    \begin{itemize}
      ...
      \item Strong text-to-image models, but bitmap outputs
      \item Structured graphics, not only rendered images
    \end{itemize}
  \end{column}
...
\begin{itemize}
  \tightitems
  \item Raster-generator adaptation for SVG-like images
  \item Custom raster-to-vector training on synthetic and SVG-derived data
  \item Flow matching vs. autoregressive and classical baselines
  \item Evaluation of fidelity, validity, compactness, and editability
\end{itemize}
\end{frame}
...
\begin{columns}[T,onlytextwidth]
  \begin{column}{.47\textwidth}
    \begin{itemize}
      ...
      \item CLIP, DINO, and vectorization MSE selection metrics
    \end{itemize}
  \end{column}
