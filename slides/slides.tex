...
\newcommand{\benchimg}[1]{\raisebox{-.5\height}{\tinyimg{#1}}}
\newcommand{\benchlabel}[1]{\raisebox{-.5\height}{\makebox[.14\textwidth][r]{\scriptsize #1}}}
...
\begin{tabular}{c@{\hspace{1.4em}$\longrightarrow$\hspace{1.4em}}c}
  ...
  \begin{minipage}{.28\textwidth}
    \centering
    \fbox{\includegraphics[width=.85\linewidth,height=.34\textheight,keepaspectratio]{lighthouse.pdf}}
...
\vspace{.2em}
{\tiny Source: NVIDIA Technical Blog~\cite{vahdat2022improvingdiffusion}}
...
\begin{tabular}{c@{\hspace{1.4em}$\longrightarrow$\hspace{1.4em}}c}
  ...
  \begin{minipage}{.18\textwidth}
    \centering
    \fbox{\includegraphics[width=.8\linewidth,height=.15\textheight,keepaspectratio]{assets/z-image-rocket-icon.jpeg}}
...
\begin{columns}[T,onlytextwidth]
  \begin{column}{.55\textwidth}
    \begin{itemize}
      \tightitems
      \item SVG Repo-derived HF dataset~\cite{mikronaiSvgSvgrepo}
      \item Approximately 216k SVG examples
      \item Raw SVG markup with titles, tags, licenses, and generated captions
      \item Shared source for raster LoRA adaptation and Bezier supervision
    \end{itemize}
  \end{column}
  \begin{column}{.4\textwidth}
    \centering
    \includegraphics[width=.96\linewidth,height=.62\textheight,keepaspectratio]{assets/dataset-slide.png}

    \vspace{.2em}
    {\tiny Examples from mikronai/svg-svgrepo~\cite{mikronaiSvgSvgrepo}}
  \end{column}
\end{columns}
\end{frame}
...
\begin{frame}{Stage 2: VTracer}
\begin{itemize}
  \tightitems
  \item Open-source raster-to-SVG converter~\cite{visioncortexVtracer}
  \item Classical tracing baseline for the vectorization stage
  \item Optimizes visual fidelity rather than semantic structure
\end{itemize}
\end{frame}
...
\begin{columns}[T,onlytextwidth]
  \begin{column}{.48\textwidth}
    \structure{Output tensor}

    \vspace{.35em}
    \begin{itemize}
      \tightitems
      \item Fixed-length sequence of cubic Bezier segments
      \item One sample is represented as $X \in \mathbb{R}^{N \times 13}$
      \item Every dimension is normalized to $[-1, 1]$
      \item Padding rows are ignored through a validity flag
    \end{itemize}
  \end{column}
  \begin{column}{.48\textwidth}
    \structure{Segment descriptor}
    ...
    \begin{itemize}
      \tightitems
      \item $(x_0,y_0)$ start point, $(x_1,y_1),(x_2,y_2)$ control points
      \item Endpoint is implicit from the next segment start point
      \item $f_p$ starts a path, $f_s$ starts a subpath, $f_r$ marks real data
    \end{itemize}
  \end{column}
\end{columns}
\end{frame}
...
\begin{frame}{Synthetic Vectorization Comparison}
\centering
\begin{tabular}{rcccccc}
\benchlabel{Reference}
 & \benchimg{vectorization_qualitative/synthetic/reference/0000.png}
 & \benchimg{vectorization_qualitative/synthetic/reference/0001.png}
 & \benchimg{vectorization_qualitative/synthetic/reference/0002.png}
 & \benchimg{vectorization_qualitative/synthetic/reference/0003.png}
 & \benchimg{vectorization_qualitative/synthetic/reference/0004.png}
 & \benchimg{vectorization_qualitative/synthetic/reference/0005.png} \\
\benchlabel{Ours 0.26B}
 & \benchimg{vectorization_qualitative/synthetic/proposed/0000.png}
 & \benchimg{vectorization_qualitative/synthetic/proposed/0001.png}
 & \benchimg{vectorization_qualitative/synthetic/proposed/0002.png}
 & \benchimg{vectorization_qualitative/synthetic/proposed/0003.png}
 & \benchimg{vectorization_qualitative/synthetic/proposed/0004.png}
 & \benchimg{vectorization_qualitative/synthetic/proposed/0005.png} \\
\benchlabel{StarVector 1B}
 & \benchimg{vectorization_qualitative/synthetic/starvector_1b/0000.png}
 & \benchimg{vectorization_qualitative/synthetic/starvector_1b/0001.png}
 & \benchimg{vectorization_qualitative/synthetic/starvector_1b/0002.png}
 & \benchimg{vectorization_qualitative/synthetic/starvector_1b/0003.png}
 & \benchimg{vectorization_qualitative/synthetic/starvector_1b/0004.png}
 & \benchimg{vectorization_qualitative/synthetic/starvector_1b/0005.png} \\
\benchlabel{OmniSVG 4B}
 & \benchimg{vectorization_qualitative/synthetic/omnisvg_4b/0000.png}
 & \benchimg{vectorization_qualitative/synthetic/omnisvg_4b/0001.png}
 & \benchimg{vectorization_qualitative/synthetic/omnisvg_4b/0002.png}
 & \benchimg{vectorization_qualitative/synthetic/omnisvg_4b/0003.png}
 & \benchimg{vectorization_qualitative/synthetic/omnisvg_4b/0004.png}
 & \benchimg{vectorization_qualitative/synthetic/omnisvg_4b/0005.png} \\
\benchlabel{vtracer}
 & \benchimg{vectorization_qualitative/synthetic/reference/0000.png}
 & \benchimg{vectorization_qualitative/synthetic/reference/0001.png}
 & \benchimg{vectorization_qualitative/synthetic/reference/0002.png}
...
\begin{frame}{Synthetic Vectorization Metrics}
\small
\begin{columns}[T,onlytextwidth]
  \begin{column}{.52\textwidth}
...
\begin{frame}{Z-Image Raster Vectorization Comparison}
\centering
\begin{tabular}{rcccccc}
\benchlabel{Raster input}
 & \benchimg{z_image_vectorization/reference/0000.png}
 & \benchimg{z_image_vectorization/reference/0001.png}
 & \benchimg{z_image_vectorization/reference/0002.png}
 & \benchimg{z_image_vectorization/reference/0003.png}
 & \benchimg{z_image_vectorization/reference/0004.png}
 & \benchimg{z_image_vectorization/reference/0005.png} \\
\benchlabel{Ours 0.26B}
 & \benchimg{z_image_vectorization/proposed/0000.png}
 & \benchimg{z_image_vectorization/proposed/0001.png}
 & \benchimg{z_image_vectorization/proposed/0002.png}
 & \benchimg{z_image_vectorization/proposed/0003.png}
 & \benchimg{z_image_vectorization/proposed/0004.png}
 & \benchimg{z_image_vectorization/proposed/0005.png} \\
\benchlabel{StarVector 1B}
 & \benchimg{z_image_vectorization/starvector_1b/0000.png}
 & \benchimg{z_image_vectorization/starvector_1b/0001.png}
 & \benchimg{z_image_vectorization/starvector_1b/0002.png}
 & \benchimg{z_image_vectorization/starvector_1b/0003.png}
 & \benchimg{z_image_vectorization/starvector_1b/0004.png}
 & \benchimg{z_image_vectorization/starvector_1b/0005.png} \\
\benchlabel{OmniSVG 4B}
 & \benchimg{z_image_vectorization/omnisvg_4b/0000.png}
 & \benchimg{z_image_vectorization/omnisvg_4b/0001.png}
 & \benchimg{z_image_vectorization/omnisvg_4b/0002.png}
 & \benchimg{z_image_vectorization/omnisvg_4b/0003.png}
 & \benchimg{z_image_vectorization/omnisvg_4b/0004.png}
 & \benchimg{z_image_vectorization/omnisvg_4b/0005.png} \\
\benchlabel{vtracer}
 & \benchimg{z_image_vectorization/vtracer/0000.png}
 & \benchimg{z_image_vectorization/vtracer/0001.png}
 & \benchimg{z_image_vectorization/vtracer/0002.png}
 & \benchimg{z_image_vectorization/vtracer/0003.png}
 & \benchimg{z_image_vectorization/vtracer/0004.png}
 & \benchimg{z_image_vectorization/vtracer/0005.png} \\
\end{tabular}
\end{frame}

\begin{frame}{Z-Image Raster Vectorization Metrics}
\small
\begin{columns}[T,onlytextwidth]
  \begin{column}{.52\textwidth}
    \structure{Generated-raster fidelity}
    ...
    \begin{tabular}{lccc}
      ...
      Method & MSE $\downarrow$ & SSIM $\uparrow$ & IoU $\uparrow$ \\
      \midrule
      Ours 0.26B & 6004.4 & .681 & .651 \\
      OmniSVG 4B & 8973.1 & .550 & .549 \\
      StarVector 1B & \metricbest{5057.5} & \metricbest{.729} & \metricbest{.690} \\
      \midrule
      vtracer & 145.5 & .984 & .971 \\
      \bottomrule
    \end{tabular}
  \end{column}
  \begin{column}{.43\textwidth}
    ...
    \begin{tabular}{lcc}
      ...
      Method & Valid & Commands \\
      \midrule
      Ours 0.26B & \metricbest{100\%} & 80 \\
      OmniSVG 4B & 99\% & 244 \\
      StarVector 1B & 49\% & \metricbest{40} \\
      \midrule
      vtracer & 100\% & 1779 \\
      \bottomrule
    \end{tabular}
